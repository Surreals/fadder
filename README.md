Generated with [vike.dev/new](https://vike.dev/new) ([version 479](https://www.npmjs.com/package/create-vike/v/0.0.479)) using this command:

```sh
pnpm create vike@latest --react --vercel --eslint --prettier
```
